      ...
      postElement.innerHTML = `
        <div class="post-content">
          ...
          <div class="comments-section">
            ...
            <input type="text" id="comment-author-input-${post.id}" placeholder="Your name" required style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 5px; margin-bottom: 10px;">
            <textarea id="comment-input-${post.id}" placeholder="Add a comment" required style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 5px; margin-bottom: 10px;"></textarea>
            <button type="submit" style="background-color: green; color: white;">Reply</button>
          </form>
          </div>
        </div>
      `;
